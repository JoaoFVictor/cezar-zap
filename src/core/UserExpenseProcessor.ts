...
import UserExpenseState from '../entities/enums/UserExpenseState';
import { UserTopic } from '../entities/UserTopic';
import { UserTopicProcessor } from './UserTopicProcessor';
import { injectable } from 'tsyringe';

@injectable()
export class UserExpenseProcessor {
    constructor(private userExpenseService: UserExpenseService, private messageService: MessageService, private userTopicProcessor: UserTopicProcessor) {
    }
    ...
    private async goBack(user: User): Promise<void> {
        ...
        await this.userTopicProcessor.displayUserTopic(user);
    }
}
