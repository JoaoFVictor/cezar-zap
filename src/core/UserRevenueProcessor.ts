...
@injectable()
export class UserRevenueProcessor {
    constructor(private userRevenueService: UserRevenueService, private messageService: MessageService, private userTopicProcessor: UserTopicProcessor) {
    }
